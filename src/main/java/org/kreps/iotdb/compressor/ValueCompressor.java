...
/**
 * ValueCompressor for the Gorilla encoding format. Supply with long
...
public class ValueCompressor {
     ...
     * previous value, control bit = 0 (type a)
    ...
    private void writeNewLeading(long xor, int leadingZeros, int trailingZeros) {
        ...
        // Different from version 1.x, use (significantBits - 1) in storage - avoids a
        // branch
        int significantBits = 64 - leadingZeros - trailingZeros;

        // Different from original, bits 5 -> 6, avoids a branch, allows storing small
        // longs
