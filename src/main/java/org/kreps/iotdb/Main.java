...
//             SessionManager.initializeSession("192.168.56.107", 6667, username, password); // Initialize a single session for setup
...
//             Iterator<DataBatch> iterator = dataQueue.iterator();

//             // while(iterator.hasNext()) {
//             //     DataBatch batch = iterator.next();
//             //     System.out.println("Batch size in Kb: " + batch.getCompressedData().length/ 1024);
//             // }
